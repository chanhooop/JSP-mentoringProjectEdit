                        ...
                        <div class="card">
                            <div class="left">
                                <div class="leftcontent">
                                    <img src="img/starwars5.jpg" alt="제다이 이미지입니다.">
                                </div>
                            </div>
                            <div class="right">
                                <div class="rightinner">
                                    ...
                                    <ul class="rightback umpright">
                                        <li>
                                         	<span>아이디 : </span>
                                         	<input type="text" value="${userInfo.userid }" name="userid" readonly="readonly">
                                        </li>
                                        <li>
                                        	<span>이름 : </span>
                                        	<input type="email" value="${userInfo.username }" name="username" readonly="readonly">
                                        </li>
                                        <li>
                                        	<span>전화 번호 : </span>
                                        	<input type="tel" value="${userInfo.userphone }" id="userphone" name="userphone">
                                        </li>
                                        <li>
                                        <span>이메일 : </span>
                                        	<input type="email" value="${userInfo.useremail }" id="useremail" name="useremail" size="50">
                                        </li>
                                        <li class="rightbtn">

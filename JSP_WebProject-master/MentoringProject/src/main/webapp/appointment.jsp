        ...
        <div class="appointment">
            <div class="row">
                ...
                <table>
					...
					<tr>
						<td colspan="6"><a href="/MentoringProject/paymentScheduleSelect.do?productpk=<%=request.getParameter("productpk") %>"><i class="fas fa-angle-double-right"></i> 가능날짜보러가기</a> </td>
					</tr>
                    </table>
                    <%-- <div class="radiobtn">
